...
import {
  ProviderResultRpcChannelsEnum,
  providerResultsRpcChannels,
} from '../enums/provider-result-channels.enum';
    ...
    this.redisSub.on('message', async (channel, message) => {
      ...
      switch (channel) {
        case ProviderResultRpcChannelsEnum.GET_PROVIDER_RESULTS: {
          ...
          const resp = await this.providerResultUseCases.findManyBy(data);
